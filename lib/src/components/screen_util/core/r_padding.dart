...
/// @nodoc
class ZegoBeautyRPadding extends SingleChildRenderObjectWidget {
  ...
  RenderPadding createRenderObject(BuildContext context) {
    return RenderPadding(
      padding: padding is ZegoBeautyREdgeInsets ? padding : padding.zR,
...
/// @nodoc
class ZegoBeautyREdgeInsets extends EdgeInsets {
  /// Creates adapt insets from offsets from the left, top, right, and bottom.
  ZegoBeautyREdgeInsets.fromLTRB(
  ...
  /// ```
  /// {@end-tool}
  ZegoBeautyREdgeInsets.all(double value) : super.all(value.zR);
  ...
  /// ```
  /// {@end-tool}
  ZegoBeautyREdgeInsets.symmetric({
    double vertical = 0,
    double horizontal = 0,
...
/// @nodoc
class ZegoBeautyREdgeInsetsDirectional extends EdgeInsetsDirectional {
  ...
  /// ```
  /// {@end-tool}
  ZegoBeautyREdgeInsetsDirectional.all(double value) : super.all(value.zR);
  ...
  /// ```
  /// {@end-tool}
  ZegoBeautyREdgeInsetsDirectional.only({
    double bottom = 0,
    double end = 0,
    double start = 0,
    double top = 0,
  ...
  ZegoBeautyREdgeInsetsDirectional.fromSTEB(
    double start,
    double top,
    double end,
    double bottom,
