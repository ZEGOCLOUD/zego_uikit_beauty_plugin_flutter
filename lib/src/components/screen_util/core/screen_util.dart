...
typedef ZegoBeautyFontSizeResolver = double Function(
    num fontSize, ZegoBeautyScreenUtil instance);

/// @nodoc
class ZegoBeautyScreenUtil {
  static const Size defaultSize = Size(360, 690);
  static final ZegoBeautyScreenUtil _instance = ZegoBeautyScreenUtil._();
  ...
  ZegoBeautyFontSizeResolver? fontSizeResolver;

  ZegoBeautyScreenUtil._();

  factory ZegoBeautyScreenUtil() => _instance;
  ...
  /// ```dart
  /// ...
  /// ZegoBeautyScreenUtil.init(context, ...);
  /// ...
  ///   FutureBuilder(
  ...
  static void configure({
    ...
    try {
      ...
      throw Exception(
          'You must either use ZegoBeautyScreenUtil.init or ScreenUtilInit first');
    }
  ...
  static Future<void> ensureScreenSizeAndInit(
    ...
    return ZegoBeautyScreenUtil.ensureScreenSize().then((_) {
      return configure(
        data: mediaQueryData,
        designSize: designSize,
        minTextAdapt: minTextAdapt,
  ...
  ZegoBeautyDeviceType deviceType() {
    ZegoBeautyDeviceType deviceType;
    switch (Platform.operatingSystem) {
      case 'android':
      case 'ios':
        deviceType = ZegoBeautyDeviceType.mobile;
        if ((orientation == Orientation.portrait && screenWidth < 600) ||
            (orientation == Orientation.landscape && screenHeight < 600)) {
          deviceType = ZegoBeautyDeviceType.mobile;
        } else {
          deviceType = ZegoBeautyDeviceType.tablet;
        }
        break;
      case 'linux':
        deviceType = ZegoBeautyDeviceType.linux;
        break;
      case 'macos':
        deviceType = ZegoBeautyDeviceType.mac;
        break;
      case 'windows':
        deviceType = ZegoBeautyDeviceType.windows;
        break;
      case 'fuchsia':
        deviceType = ZegoBeautyDeviceType.fuchsia;
        break;
      default:
        deviceType = ZegoBeautyDeviceType.web;
    }
    return deviceType;
  }
...
enum ZegoBeautyDeviceType { mobile, tablet, web, mac, windows, linux, fuchsia }
