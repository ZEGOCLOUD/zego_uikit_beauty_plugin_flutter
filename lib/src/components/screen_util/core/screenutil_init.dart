...
// Project imports:
import 'package:zego_uikit_beauty_plugin/src/components/screen_util/core/_flutter_widgets.dart';
import 'package:zego_uikit_beauty_plugin/src/components/screen_util/core/screen_util.dart';
import 'package:zego_uikit_beauty_plugin/src/components/screen_util/core/screenutil_mixin.dart';

typedef ZegoBeautyRebuildFactor = bool Function(
    MediaQueryData old, MediaQueryData data);

typedef ZegoBeautyScreenUtilInitBuilder = Widget Function(
  BuildContext context,
  Widget? child,
);

/// @nodoc
abstract class ZegoBeautyRebuildFactors {
...
abstract class ZegoBeautyFontSizeResolvers {
  static double width(num fontSize, ZegoBeautyScreenUtil instance) {
    return instance.setWidth(fontSize);
  }

  static double height(num fontSize, ZegoBeautyScreenUtil instance) {
    return instance.setHeight(fontSize);
  }

  static double radius(num fontSize, ZegoBeautyScreenUtil instance) {
    return instance.radius(fontSize);
  }

  static double diameter(num fontSize, ZegoBeautyScreenUtil instance) {
    return instance.diameter(fontSize);
  }

  static double diagonal(num fontSize, ZegoBeautyScreenUtil instance) {
...
class ZegoBeautyScreenUtilInit extends StatefulWidget {
  ...
  const ZegoBeautyScreenUtilInit({
    ...
    this.designSize = ZegoBeautyScreenUtil.defaultSize,
  ...
  final ZegoBeautyRebuildFactor rebuildFactor;
  final ZegoBeautyFontSizeResolver fontSizeResolver;
  ...
  @override
  State<ZegoBeautyScreenUtilInit> createState() =>
      _ZegoBeautyScreenUtilInitState();
}

class _ZegoBeautyScreenUtilInitState extends State<ZegoBeautyScreenUtilInit>
